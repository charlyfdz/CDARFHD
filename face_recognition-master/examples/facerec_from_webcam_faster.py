...
arisa_image = face_recognition.load_image_file("./images/arisa.jpg")
arisa_face_encoding = face_recognition.face_encodings(arisa_image)[0]

# Load a second sample picture and learn how to recognize it.
carlos_image = face_recognition.load_image_file("./images/carlos1.jpg")
